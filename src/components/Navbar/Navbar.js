  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a className="nav-link" href="/">R <span className="sr-only">(current)</span></a>
          </li>
          <li class="link" className="nav-item ">
            <a className="nav-link" href="/Reminders"><NavLink exact to="/reminders">Reminders</NavLink></a>
          </li>
          <li className="nav-item ">
            <a class="link" className="nav-link" href="/DegreeChanges"><NavLink exact to="/degreeChanges">Degree Changes</NavLink></a>
          </li>
          <li className="nav-item ">
